...
2. If we have more people reading more scientific research, statistically there will be more people that put the dots together and discover scientific breakthroughs. 
...
No, there is more to it. Science is the area we feel Aletheia can make the largest impact as fast as possible, but it's clear a free distrubuted and decentralised database designed for resilience has a number of applications. One of the goals of Aletheia is to prove this technology works so we can get to those other applications. Along with science, Aletheia is about advancing decentralised technology, making it open source and bringing it to multiple industries.
