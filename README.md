...
Aletheia was founded on the principle that knowledge should be open and that software should be open. We as the founders beleive wholeheartedly that these two ideals are some of the foundations of building a better world. In this spirit a large amount of Aletheia is licensed under *Creative Commons Attribution Share Alike 4.0* license and *GNU Lesser General Public License v3.0* for materials and source code respectively. These licenses mean you can take what we have made and create something else with it, such freedom we feel should be a basic right, however you must also make whatever you create with the Aletheia material and source code free for people to take and create things with. We have locked in the "idea" of Aletheia, a decentralised and distributed database for publishing electronic media, into the public domain, this was a deliberate design choice. The second however is that we have taken the contents of a couple of other repositories to help create Aletheia, and this material is licensed differently. When forking Aletheia to create your own work be mindful that separate repositories are licensed differently.
